...
const SEMINAR_TITLES = {
  ...
  "5670": "DEEP INSIGHT WEDNESDAY WEBINAR_Dual Regeneration Strategy: ECM Restoration & Collagen Biostimulation",
  "5670_DH": "[대한심부전학회] 디지털헬스연구회 제 13차 웹심포지엄",
  "5669": "True Cardiovascular Event Prevention from the HEART, CRESTOR",
  ...
  "5639": "[ENDO WEEK] Libre Web Symposium",
  ...
  "5631": "신경과에서 바라보는 펙수클루",
  "5629": "[Libre Week] A New Paradigm in Obesity Management",
  "5511": "전공의를 위한 최신 간질환 가이드라인 및 증례 강의",
  "5539": "이상지질혈증 1차 치료 전략에서 피에젯타의 임상적 역할",
  "5587": "전공의를 위한 응급실 증례강의",
  "5603": "눈으로 읽는 심혈관 위험: 안저 기반 CVD 평가의 임상적 활용",
  "5694": "Global Journal Club 2026",
  "SP_IPSI": "입시를 몰라도 자녀와 대화가 통하게 되는 50분",
  "SP_CHATGPT": "ChatGPT 실용 입문 — AI로 알아보고, 읽고, 만들고, 검증하기",
  "SP_YOGA": "직장인들을 위한 점심 빤짝, 오피스요가 스트레칭&호흡명상",
